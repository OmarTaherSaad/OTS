...
{
    public function index(LinkedInExperienceService $linkedInExperience)
    {
        ...
        $packages = [
            ...
            [
                ...
                'price_usd' => 1000,
                'period' => 'project',
                'tagline' => 'Custom build for serious online businesses.',
                'features' => [
            ...
            [
                ...
                'price_usd' => 1800,
                'period' => 'project',
                'tagline' => 'High-traffic online businesses, complex integrations and automation.',
                'features' => [
                    'Custom Laravel / WordPress / Shopify build',
                    'Up to 20 third-party integrations (payment gateways, shipping, SMS, KYC, Loyalty, etc.)',
                    'Admin dashboard for content management',
                    'Automated Background tasks (e.g. sending emails, SMS, etc.)',
                    'Performance + SEO optimization',
        ...
        $retainers = [
            [
                ...
                'price_usd' => null,
                'period' => 'month',
                'tagline' => 'Keep things running — bug fixes, monitoring, and small updates.',
                'features' => [
                    '~10–20 hours per month',
                    'Bug fixes + dependency updates',
                    'Uptime + error monitoring',
                    'Small content / copy tweaks',
            ...
            [
                ...
                'price_usd' => null,
                'period' => 'month',
                'tagline' => 'Treat me as part of your team — ongoing feature work and system ownership.',
                'features' => [
                    '~40–80 hours per month',
                    'New features + iterations',
                    'Architecture + code review',
                    'Integrations + automation work',
                    'Daily status reports + sync calls included',
                    'Direct line during business hours',
                    'Priority over maintenance clients',
                ],
                'cta' => 'Talk to me',
                'highlighted' => true,
            ],
