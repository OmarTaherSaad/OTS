                ...
                <div class="row">
                    <div class="col-12 my-2">
                        <div class="form-group my-1 {{ old('name') ? 'focused' : '' }}">
                            ...
                            <input class="form-control {{ $errors->has('name') ? 'is-danger filled invalid' : (old('name') ? 'filled valid' : '') }}" type="text"
                    ...
                    <div class="col-xl-6 col-12 my-2">
                        <div class="form-group my-1 {{ old('phone') ? 'focused' : '' }}">
                            ...
                            <input class="form-control {{ $errors->has('phone') ? 'is-danger filled invalid' : (old('phone') ? 'filled valid' : '') }}" type="tel"
                                name="phone" value="{{ old('phone') }}" required pattern="[0-9]{5,}">
                        </div>
                        @error('phone')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-xl-6 col-12 my-2">
                        <div class="form-group my-1 {{ old('email') ? 'focused' : '' }}">
                            ...
                            <input class="form-control {{ $errors->has('email') ? 'is-danger filled invalid' : (old('email') ? 'filled valid' : '') }}" type="email"
                    ...
                    <div class="col-12 my-2">
                        <div class="form-group my-1 {{ old('subject') ? 'focused' : '' }}">
                            ...
                            <input class="form-control {{ $errors->has('subject') ? 'is-danger filled invalid' : (old('subject') ? 'filled valid' : '') }}" type="text"
