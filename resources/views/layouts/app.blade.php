...
<head>
    ...
    <link rel="apple-touch-icon" sizes="114x114"
        href="{{ asset('storage/assets/icons/apple-touch-icon-114x114.png') }}" />
    <link rel="apple-touch-icon" sizes="120x120"
        href="{{ asset('storage/assets/icons/apple-touch-icon-120x120.png') }}" />
    <link rel="apple-touch-icon" sizes="144x144"
        href="{{ asset('storage/assets/icons/apple-touch-icon-144x144.png') }}" />
    <link rel="apple-touch-icon" sizes="152x152"
        href="{{ asset('storage/assets/icons/apple-touch-icon-152x152.png') }}" />
...
<body id="page-top">
    ...
    <div id="app"
        class="{{ App::isLocale('ar') ? 'rtl' : 'ltr' }} container-fluid @if(Request::route()->named('index')) px-0 @else pt-3 @endif">
