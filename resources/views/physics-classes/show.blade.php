...
<div class="row my-1">
    <div class="col-12 col-md-auto">
        <a href="/projects" class="btn btn-primary"><i
                class="fas fa-arrow-alt-circle-{{ App::getLocale() == 'ar' ? 'right' : 'left' }}"></i>&nbsp;
            {{ __('admin.AllProjects') }}</a>
    </div>
</div>
    ...
    <div class="col-12 col-md-6">
        <form action="/admin/projects/{{ $Project->id }}" method="post" class="needs-validation" novalidate>
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="{{ __('admin.ProjectName') }}"
                    value="{{ $Project->name }}" required>
            </div>

            <div class="form-group">
                <label for="description">{{ __('admin.ProjectDesc') }}</label>
                <textarea name="description" class="form-control wysiwyg" placeholder="{{ __('admin.ProjectDesc') }}"
                ...
                <div class="col-6 col-md-4">
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="delete_files[]"
                                value="{{ $image->filename }}" style="transform: scale(1.7)">
