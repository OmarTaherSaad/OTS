...
@section('content')
  ...
  <div id="home" class="intro route bg-image" style="background-image: url({{ Storage::url('assets/images/BGs/bg4.jpg') }})">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="intro-subtitle"><span class="text-slider-items">Computer Engineer,Full Stack Web Developer,Video Editor,Founder of Thanawya Helwa,Graphic Designer</span><strong class="text-slider"></strong></p>
  ...
  <main id="main">
                ...
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-sm-6 col-md-5">
                      <div class="about-img">
                        <img src="{{ Storage::url('assets/images/Personal Photo.jpg') }}" class="img-fluid rounded b-shadow-a" alt="">
                      </div>
                    </div>
    ...
    {{-- Portfolio --}}
    <section id="work" class="portfolio-mf sect-pt4 route bg-image" style="background-image: url({{ Storage::url('assets/images/BGs/bg1.jpg') }})">
      <div class="overlay-itro"></div>
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
              ...
              <a href="{{ Storage::url('assets/images/projects/csharp-memoryAllocator.jpg') }}" data-gall="portfolioGallery" class="venobox">
                ...
                <div class="work-content">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <a href="https://github.com/OmarTaherSaad/MemoryAllocator" target="_blank">Open</a>
                    </div>
                  </div>
                </div>
              </a>
              ...
              <a href="{{ Storage::url('assets/images/projects/radiobanner.jpg') }}" data-gall="portfolioGallery" class="venobox">
                ...
                <div class="work-content">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <a href="https://www.behance.net/gallery/96867831/-Negative-Sertonin" target="_blank">Open</a>
                    </div>
                  </div>
                </div>
              </a>
    ...
    {{-- Portfolio END --}}
    {{-- Contact --}}
    <section class="paralax-mf bg-image route" style="background-image: url({{ Storage::url('assets/images/BGs/bg3.jpg') }})">
        ...
        <div class="row">
            <div class="col-12">
                <div class="jumbotron mt-lg-3 mt-5">
                    ...
                    <p class="lead">{{ __("It's hard to answer immediately, but I will do as fast as possible") }}</p>
                </div>
            </div>
        </div>
