            ...
            <div class="col-12 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="course" id="course" required>
                        ...
                        @foreach ($courses as $id => $name)
                            <option value="{{ $id }}" @selected($id == $appointment->course->id)>{{ $name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <input type="date" name="start_at" class="form-control"
                        value="{{ $appointment->start_at->format('Y-m-d') }}" required>
                </div>
                <div class="form-group">
                    <label for="end_at">End Date</label>
                    <input type="date" name="end_at" class="form-control"
                        value="{{ $appointment->end_at->format('Y-m-d') }}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" min=0 name="max_attendees" class="form-control"
                        value="{{ $appointment->max_attendees }}" required>
                </div>
                <div class="form-group">
