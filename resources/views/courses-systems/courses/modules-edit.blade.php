    ...
    <div class="row justify-content-center mt-2">
        <div class="col-12 col-md-6">
            ...
            <div class="input-group mb-3">
                ...
                <input type="number" class="form-control" aria-label="order" name="order" value="{{ $coursemodule->order }}">
            </div>

            <div class="form-check">
                <label class="form-check-label">
                    <input type="checkbox" class="form-check-input" name="is_prereq" id="is_prereq" value="1" @if($coursemodule->is_prereq) checked @endif>
                    Is Prerequisite
                </label>
            </div>
