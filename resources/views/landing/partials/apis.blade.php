        ...
        <div class="marquee-track flex items-center gap-8 w-max">
            ...
            @foreach ($allLogos as $logo)
                <div style="background:#fff;"
                     class="shrink-0 h-24 w-44 px-5 flex items-center justify-center rounded-2xl ring-1 ring-ink-200 dark:ring-white/10 hover:ring-brand-500 transition-all hover:-translate-y-1 hover:shadow-xl dark:shadow-md">
