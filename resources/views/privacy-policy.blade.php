...
@section('content')
    <div class="row" dir="ltr">
        <div class="col-12 col-md-10">
            ...
            <p>Your privacy is important to us. It is OTS's policy to respect your privacy regarding any information we
                may collect from you across our website, <a href="https://www.omartahersaad.com/">www.omartahersaad.com</a>, and other sites we own and operate.
            </p>
    ...
    <div class="row" dir="ltr">
        <div class="col-12 col-md-10">
            <h2>OTS Terms of Service</h2>
            <h3>1. Terms</h3>
            <p>By accessing the website at <a href="https://www.omartahersaad.com/">www.omartahersaad.com</a>, you are
            ...
            <ol type="a">
                <li>Permission is granted to temporarily download one copy of the materials (information or software) on Thanawya
                    ...
                    <ol type="i">
                        ...
                        <li>attempt to decompile or reverse engineer any software contained on OTS's website;</li>
                ...
                <li>This license shall automatically terminate if you violate any of these restrictions and may be terminated by
                    OTS at any time. Upon terminating your viewing of these materials or upon the termination of this
                    license, you must destroy any downloaded materials in your possession whether in electronic or printed format.
                </li>
            </ol>
            <h3>3. Disclaimer</h3>
            <ol type="a">
                <li>The materials on OTS's website are provided on an 'as is' basis. OTS makes no warranties,
                ...
                <li>Further, OTS does not warrant or make any representations concerning the accuracy, likely results, or
            ...
            <h3>4. Limitations</h3>
            <p>In no event shall OTS or its suppliers be liable for any damages (including, without limitation, damages
                for loss of data or profit, or due to business interruption) arising out of the use or inability to use the
                materials on OTS's website, even if OTS or a OTS authorized representative has been
            ...
            <p>The materials appearing on OTS's website could include technical, typographical, or photographic errors.
                OTS does not warrant that any of the materials on its website are accurate, complete or current. Thanawya
                Helwa may make changes to the materials contained on its website at any time without notice. However OTS
                does not make any commitment to update the materials.</p>
            <h3>6. Links</h3>
            <p>OTS has not reviewed all of the sites linked to its website and is not responsible for the contents of any
                such linked site. The inclusion of any link does not imply endorsement by OTS of the site. Use of any
                such linked website is at the user's own risk.</p>
            <h3>7. Modifications</h3>
            <p>OTS may revise these terms of service for its website at any time without notice. By using this website
